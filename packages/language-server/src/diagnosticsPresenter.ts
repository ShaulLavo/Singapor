...
export class DiagnosticsPresenter {
  ...
  public constructor(
    ...
    prefix: string,
    private readonly onDiagnostics: ((summary: LanguageServerDiagnosticSummary) => void) | undefined,
  ) {
...
function minimapSeverityForDiagnostic(diagnostic: lsp.Diagnostic): LanguageServerDiagnosticSeverity {
