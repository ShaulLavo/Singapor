...
const INLINE_CODE_BACKGROUND_VARIABLE = '--editor-language-server-hover-inline-code-background'
const CODE_BLOCK_BACKGROUND_VARIABLE = '--editor-language-server-hover-code-block-background'
...
export function renderTooltipMarkdown(
  ...
  root.className = 'editor-language-server-hover-markdown'
...
function typeScriptTokenElement(document: Document, token: string): HTMLElement {
  ...
  element.className = `editor-language-server-hover-token-${tokenKind}`
